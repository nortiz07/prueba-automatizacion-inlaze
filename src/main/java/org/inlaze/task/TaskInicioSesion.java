...
public class TaskInicioSesion implements Task {

    private final String email;

    private final String password;

    public TaskInicioSesion(String email, String password) {
        this.email = email;
    ...
    public static TaskInicioSesion inicioSesion(String email, String password){
        return new TaskInicioSesion(email,password);
    }
}
